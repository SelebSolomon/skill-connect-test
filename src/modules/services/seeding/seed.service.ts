...
export const INITIAL_SERVICES = [
  // Home Maintenance
  {
    ...
    description: 'Pipe fitting, leak repairs, water systems',
    tags: ['home', 'repair', 'water', 'pipes'],
  },
  {
    name: 'Electrician',
    category: 'Home Maintenance',
    description: 'Electrical installations and repairs',
    tags: ['home', 'repair', 'electrical', 'wiring'],
  },
  {
    name: 'Carpenter',
    category: 'Home Maintenance',
    description: 'Wood work, furniture, doors, windows',
    tags: ['home', 'repair', 'wood', 'furniture'],
  },
  {
    name: 'Painter',
    category: 'Home Maintenance',
    description: 'Interior and exterior painting',
    tags: ['home', 'paint', 'decoration'],
  },
  {
    name: 'Tiler',
    category: 'Home Maintenance',
    description: 'Floor and wall tiling',
    tags: ['home', 'tiles', 'flooring'],
  },
  {
    name: 'Mason',
    category: 'Home Maintenance',
    description: 'Bricklaying and masonry work',
    tags: ['home', 'construction', 'building'],
  },
  {
    name: 'Welder',
    category: 'Home Maintenance',
  ...
  // Automotive
  {
    ...
    tags: ['auto', 'car', 'repair', 'engine'],
  },
  {
    name: 'Auto Electrician',
    category: 'Automotive',
    description: 'Vehicle electrical systems',
    tags: ['auto', 'car', 'electrical'],
  },
  {
    name: 'Panel Beater',
    category: 'Automotive',
    description: 'Auto body repair',
    tags: ['auto', 'car', 'body', 'dent'],
  },
  {
    name: 'Vulcanizer',
    category: 'Automotive',
    description: 'Tire repair and replacement',
    tags: ['auto', 'tire', 'wheel'],
  },
  {
    name: 'Car Wash',
    category: 'Automotive',
    description: 'Vehicle cleaning services',
    tags: ['auto', 'car', 'cleaning', 'wash'],
  },
  ...
  },
  {
    name: 'Braider',
    category: 'Beauty & Personal Care',
    description: 'Hair braiding specialist',
  ...
  },
  {
    name: 'Loctician',
    category: 'Beauty & Personal Care',
    description: 'Dreadlock specialist',
    tags: ['beauty', 'hair', 'locs', 'dreadlocks'],
  },
  ...
  // Education & Tutoring
  {
    ...
    tags: ['education', 'teaching', 'tutoring'],
  },
  {
    name: 'Music Teacher',
    category: 'Education & Tutoring',
    description: 'Music lessons and training',
    tags: ['education', 'music', 'teaching'],
  },
  {
    name: 'Driving Instructor',
    category: 'Education & Tutoring',
    description: 'Driving lessons and training',
    tags: ['education', 'driving', 'training'],
  },
  {
    name: 'Language Tutor',
    category: 'Education & Tutoring',
  ...
  // Creative & Media
  {
    ...
    tags: ['creative', 'photography', 'media'],
  },
  {
    name: 'Videographer',
    category: 'Creative & Media',
    description: 'Video production services',
    tags: ['creative', 'video', 'media'],
  },
  {
    name: 'Graphic Designer',
    category: 'Creative & Media',
    description: 'Design and branding',
    tags: ['creative', 'design', 'graphics'],
  },
  {
    name: 'DJ',
    category: 'Creative & Media',
    description: 'Music mixing and entertainment',
    tags: ['creative', 'music', 'entertainment', 'events'],
  },
  {
    name: 'MC',
    category: 'Creative & Media',
    description: 'Event hosting and compere',
    tags: ['creative', 'events', 'hosting'],
  },
  ...
  },
  {
    name: 'Caregiver',
    category: 'Healthcare',
    description: 'Elderly and patient care',
    tags: ['health', 'care', 'elderly'],
  },
  {
  ...
  },
  {
    name: 'Baker',
    category: 'Events & Catering',
    description: 'Baking and pastries',
    tags: ['food', 'baking', 'pastries'],
  },
  {
    name: 'Event Planner',
    category: 'Events & Catering',
  ...
  // Technology
  {
    ...
    tags: ['tech', 'phone', 'repair', 'mobile'],
  },
  {
    name: 'Computer Technician',
    category: 'Technology',
    description: 'Computer repair and support',
  ...
  },
  {
    ...
    tags: ['tech', 'web', 'development', 'coding'],
  },
  ...
  },
  {
    name: 'Shoemaker',
    category: 'Fashion & Tailoring',
    description: 'Shoe repair and making',
    tags: ['fashion', 'shoes', 'cobbler'],
  },
  ...
  },
  {
    ...
    tags: ['cleaning', 'laundry', 'washing'],
  },
  {
    name: 'Dry Cleaner',
    category: 'Cleaning',
    description: 'Professional dry cleaning',
    tags: ['cleaning', 'laundry', 'dry-clean'],
  },
  ...
  // Transportation
  {
    ...
    tags: ['transport', 'driving', 'chauffeur'],
  },
  {
    name: 'Dispatch Rider',
    category: 'Transportation',
    description: 'Delivery and courier services',
    tags: ['transport', 'delivery', 'courier'],
  },
  ...
  // Security
  {
    ...
    tags: ['security', 'protection', 'guard'],
  },
  ...
  // Construction
  {
    ...
    tags: ['construction', 'building', 'bricks'],
  },
  {
    name: 'Roofer',
    category: 'Construction',
    description: 'Roofing installation and repair',
    tags: ['construction', 'roofing', 'building'],
  },
